    ...
    return(
      ...
      <section className="your-section">
        ...
        <section className="btn-section">
          ...
          <SectionBtn image="https://static.thenounproject.com/png/4693940-200.png" title="Your videos" uid="sections-options2"></SectionBtn>
          ...
          <SectionBtn image="https://www.iconpacks.net/icons/1/free-scissors-icon-981-thumb.png" title="Your clips" uid="sections-options2"></SectionBtn>
